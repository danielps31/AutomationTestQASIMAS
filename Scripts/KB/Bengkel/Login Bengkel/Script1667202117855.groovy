...
WebUI.setText(findTestObject('Object Repository/Page_Pega Platform/input_User name_UserIdentifier'), 'testbengkel@uat')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Pega Platform/input_Password_Password'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Page_Pega Platform/span_Log in'))
