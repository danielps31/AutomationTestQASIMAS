...
WebUI.uploadFile(findTestObject('Object Repository/Page_Formulir/UploadForm'), 'Assets/File Upload/Dokumen/Foto Formulir klaim.png')
...
WebUI.uploadFile(findTestObject('Page_Formulir/UploadForm'), 'Assets/File Upload/Dokumen/Foto Formulir klaim.png')
