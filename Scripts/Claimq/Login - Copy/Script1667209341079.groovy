...
WebUI.setText(findTestObject('Object Repository/Page_Pega Platform/input_User name_UserIdentifier'), 'surveyorasmtest')
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Pega Platform/button_Log in'))
